...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("","COURSE_ID","SECOND_Q","SECOND_Q_ANSWER","DURATION","MAX_RESULT","STAGE_ORDER","CORRECT_TWO","CORRECT_ONE","CORRECT_FIVE","CORRECT_THREE","CORRECT_FOUR","FIRST_Q","FIRST_Q_ANSWER","FIVE_Q","FIVE_Q_ANSWER","THIRD_Q","THIRD_Q_ANSWER","FOUR_Q","FOUR_Q_ANSWER",""),
		...
		"LIST_PROPERTY_CODE" => array("T_COURSE_ID","TEXT_COURSE",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "20",
		...
		"SEF_FOLDER" => "/theory/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("detail"=>"course/#ELEMENT_CODE#/","news"=>"","section"=>"#SECTION_CODE#/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
